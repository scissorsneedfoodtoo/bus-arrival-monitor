...
//   let finalResult = {};
//
//   finalResult['kyungdaeAptCorner'] = await kyungdaeAptCorner.evaluate(() => {
...
//   });
//
//   finalResult['kyungdaeAptFront'] = await kyungdaeAptFront.evaluate(() => {
//     const busses = document.querySelectorAll('#ct > div.dp > ul li');
//     let kyungdaeAptFrontBusData = {
//       busStopNameAndStatus: document.querySelector('#ct > div.dp > div > h3').innerText,
//       busses: []
//     };
//
...
//       };
//
//       kyungdaeAptFrontBusData.busses.push(currBus);
//     }
//
//     return kyungdaeAptFrontBusData;
//   });
//
//   browser.close();
//   return finalResult;
